...
module ``02: About Binding`` = 
    ...
    let ``03 There are many types of values`` () =
        ...
        let b = 0.02
        let c = true
        let d = "I'm not making sense, does that makes sense?"
        let e = 'a'
        let f = ()
...
*)
   ...
   *)
    ...
    let ``08 An identifier pattern will match anything`` () =
        ...
        let y ="Yebo yes" // replace with a string
        let z = 25 // replace with anything else!
    ...
    let ``09 A wildcard pattern will match anything`` () =
        ...
        let _ = "Haibo" // replace with a string
        let _ = 0.1 // replace with anything else!
        ()
